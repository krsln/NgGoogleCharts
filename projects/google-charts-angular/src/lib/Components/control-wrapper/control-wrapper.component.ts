...
import {ChartBase} from "../../Models/ChartBase";
import {FilterType} from "../../Models/Enums";
import {ChartErrorEvent, ChartReadyEvent} from "../../Models/Events";
...
export class ControlWrapperComponent implements OnInit, OnChanges {
   ...
   *
   * For example, a range slider state can be described in terms of the positions that the low and high thumb
